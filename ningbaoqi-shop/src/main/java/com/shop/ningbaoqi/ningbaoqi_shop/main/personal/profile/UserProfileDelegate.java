...
import com.shop.ningbaoqi.ningbaoqi_shop.main.personal.settings.NameDelegate;
...
public class UserProfileDelegate extends NingbaoqiDelegate {
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        final ListBean image = new ListBean.Builder()
                .setItemType(ListItemType.ITEM_AVATER)
                .setId(1)
